...
about the implementation of the schema in the ASTR package in [the
dedicated
vignette](https://archaeothommy.github.io/ASTR/articles/VG.ASTR.Schema.Implementation.md).
...
- For isotopic ratios, use simple forms such as `206Pb/204Pb`,
  ...
  isotope in the numerator (e.g. write `e143Nd` instead of `eNd`).
- If your dataset includes columns with additional information such as
