...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("archaeothommy/ASTR", fork = TRUE)`.
...
- New code should follow the tidyverse [style
  guide](https://style.tidyverse.org) with some minor modifications. You
  can use the [styler](https://CRAN.R-project.org/package=styler)
  package to apply these styles. You should use the
  [lintr](https://CRAN.R-project.org/package=lintr) package to check
  that your code adheres to the code style. Please don’t restyle code
...
Please note that ASTR is released with a [Contributor Code of
Conduct](https://archaeothommy.github.io/ASTR/CODE_OF_CONDUCT.md). By
contributing to this project you agree to abide by its terms.

## Acknowledgement

This contributor guide was is adopted from the [contributor guide of
readr](https://github.com/tidyverse/readr/blob/main/.github/CONTRIBUTING.md).
