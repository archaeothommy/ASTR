...
3. They can represent data in a multidimensional space and enable users to effectively compare different datasets either graphically or mathematically (see also @DeCeuster2025 for the advantages of the use of one-dimensional KDE’s).
