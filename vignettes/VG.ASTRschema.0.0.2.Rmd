...
- Units for values should follow element or oxide, as `_<unit>`. Units supported include *all SI units*, as well as *ppm*, *ppb*, *ppt*, *ppq*, *%*, *wt%*, *at%*, *‰*, *counts*, and *cps*, noted as such. For relative units, the type of concentration can be specified, e.g. *w/w%* or *ppm(m/v)*
