...
- If you have columns with Pb isotope model calculations in your dataset prior to importing data, ensure the names do **not** contain a dash (‘-’) or underscore (‘_’) and specify these columns as context in the `read_archem` function. The function `<pb_iso_age_model()>` can calculate model ages, µ (^238^U/^204^Pb), and κ (^232^Th/^238^U) values using the Stacey & Kramers (1975), Cumming & Richards (1975), and Albarède & Juteau (1984) systems within ASTR.

- The following notations will be automatically identified and replaced with `NA`:
 *‘NA’*, *‘N.A.’*, *‘N/A’*, *‘na’*, *‘n/a’*, *‘-’*, and *‘n.d.’*. Values containing common excel error messages (*#DIV/0!*, *#VALUE!*, *#REF!*, *#NAME?*, *#NUM!*, *#N/A*, and *#NULL!*) are also replaced by `NA` automatically.

- Analytical precision should be indicated in the column name as: `_err2SD`, `_errSD`, `_err2SD%`, `_errSD%`, `_errSE`, `_err2SE` without indicating the unit. The unit will be inferred from the corresponding composition column. 
