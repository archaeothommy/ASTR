...
#' convertable units of the values intended to be converted to ensure that e.g.
#' normalisation is not performed on subsets.
#'
#' Only the converted values of the input are intended to be processed further
#' and except for them, columns of the unconverted ASTR object should be made
#' available to the user in the function calling this unit converter.
#'
